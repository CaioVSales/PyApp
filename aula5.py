...
class Janela(QMainWindow):
    def __init__(self):
        ...
        botao_caixa.setStyleSheet('QPushButton{background-color:#620032;font:bold;font-size:20px}')
        ...
        self.label_caixa.setStyleSheet('QLabel{font:bold;font-size:25px;color:"purple"}')
